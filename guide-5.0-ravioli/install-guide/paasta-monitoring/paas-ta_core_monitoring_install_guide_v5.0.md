# PAAS-TA\_CORE\_MONITORING\_INSTALL\_GUIDE\_V5.0

### Table of Contents

1. [개요](paas-ta_core_monitoring_install_guide_v5.0.md#101)
   * [목적](paas-ta_core_monitoring_install_guide_v5.0.md#102)
   * [범위](paas-ta_core_monitoring_install_guide_v5.0.md#103)
   * [참고 자료](paas-ta_core_monitoring_install_guide_v5.0.md#104)
2. [PaaS-TA 5.0](paas-ta_core_monitoring_install_guide_v5.0.md#105)
   * [PaaS-TA 3.1](paas-ta_core_monitoring_install_guide_v5.0.md#106)
   * [PaaS-TA 5.0](paas-ta_core_monitoring_install_guide_v5.0.md#107)
3. [PaaS-TA 5.0 설치](paas-ta_core_monitoring_install_guide_v5.0.md#108)
   * [Prerequisite](paas-ta_core_monitoring_install_guide_v5.0.md#109)
   * [설치 파일 다운로드](paas-ta_core_monitoring_install_guide_v5.0.md#1010)
   * [Stemcell 업로드](paas-ta_core_monitoring_install_guide_v5.0.md#1011)
   * [Cloud Config 설정](paas-ta_core_monitoring_install_guide_v5.0.md#1012)
     * [azs](paas-ta_core_monitoring_install_guide_v5.0.md#1013)
     * [vm types](paas-ta_core_monitoring_install_guide_v5.0.md#1014)
     * [compilation](paas-ta_core_monitoring_install_guide_v5.0.md#1015)
     * [disk size](paas-ta_core_monitoring_install_guide_v5.0.md#1016)
     * [networks](paas-ta_core_monitoring_install_guide_v5.0.md#1017)
   * [Runtime Config 설정](paas-ta_core_monitoring_install_guide_v5.0.md#1018)
     * [Runtime Config 업데이트](paas-ta_core_monitoring_install_guide_v5.0.md#1019)
   * [PaaS-TA 설치 파일](paas-ta_core_monitoring_install_guide_v5.0.md#1020)
   * [PaaS-TA 설치 Shell Scripts](paas-ta_core_monitoring_install_guide_v5.0.md#1021)
     * [deploy-aws-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1022)
     * [deploy-openstack-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1023)
     * [deploy-azure-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1024)
     * [deploy-gcp-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1025)
     * [deploy-vsphere-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1026)
     * [deploy-bosh-lite-monitoring.sh](paas-ta_core_monitoring_install_guide_v5.0.md#1027)
     * [PaaS-TA Operation 파일](paas-ta_core_monitoring_install_guide_v5.0.md#1028)
     * [PaaS-TA Variable List](paas-ta_core_monitoring_install_guide_v5.0.md#1029)
   * [PaaS-TA 설치](paas-ta_core_monitoring_install_guide_v5.0.md#1030)
   * [PaaS-TA 로그인](paas-ta_core_monitoring_install_guide_v5.0.md#1031)
...
본 문서는 cf-deployment v9.3.0을 기준으로 작성되었다. PaaS-TA는 bosh-deployment를 기반으로 한 BOSH 환경에서 설치한다. PaaS-TA 설치 시 필요한 Stemcell은 ubuntu-xenial-315.36이다.
...
![](../../../.gitbook/assets/bosh2%20%284%29.png)
...
PaaS-TA 사이트에서 \[PaaS-TA Release\] 파일을 내려받아 ${HOME}/workspace/paasta-5.0/release 이하 디렉터리에 압축을 푼다. 압출을 풀면 아래와 같이 ${HOME}/workspace/paasta-5.0/release/paasta-monitoring 디렉터리가 생성되며 릴리즈 파일\(tgz\)이 존재한다.
...
PaaS-TA는 Ubuntu xenial stemcell 315.36를 기반으로 한다. Stemcell은 배포 시 생성되는 PaaS-TA VM Base OS Image이다. BOSH 로그인 후 다음 명령어를 수행하여 Stemcell을 올린다. {director\_name}은 BOSH 설치 시 사용한 Director 명이다.
...
PaaS-TA를 설치하기 위한 IaaS 관련 Network, Storage, VM 관련 설정을 Cloud Config로 정의한다. PaaS-TA 설치 파일을 내려받으면 ${HOME}/workspace/paasta-5.0/deployment/cloud-config 디렉터리 이하에 IaaS별 Cloud Config 예제를 확인할 수 있으며, 예제를 참고하여 cloud-config.yml을 IaaS에 맞게 수정한다. PaaS-TA 배포 전에 Cloud Config를 BOSH에 적용해야 한다.
...
※ 다음은 OpenStack에서 정의한 Flavor Type이다. ![](../../../.gitbook/assets/flavor%20%282%29.png)
...
| deploy-aws-monitoring.sh | AWS 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
| :--- | :--- |
| deploy-openstack-monitoring.sh | OpenStack 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
| deploy-vsphere-monitoring.sh | VMware vSphere 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
| deploy-gcp-monitoring.sh | GCP\(Google Cloud Platform\) 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
| deploy-azure-monitoring.sh | MS Azure 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
| deploy-bosh-lite-monitoring.sh | BOSH-LITE 환경에 PaaS-TA 설치를 위한 Shell script 파일 |
...
|  -v | PaaS-TA 설치 시 적용하는 변숫값 또는 Option 파일에 변숫값을 설정할 경우 사용한다. Option 파일 속성에 따라 필수 또는 선택 항목으로 나뉜다. |

### 3.7.   PaaS-TA 설치 Shell Scripts
...
다음은 PaaS-TA 배포 시 필수 옵션이며, cf\_admin\_password, cc\_db\_encryption\_key, uaa\_database\_password, cc\_database\_password는 –v 옵션이 없는 경우 BOSH에서 자동 생성하여 BOSH CredHub에 저장한다.

#### 3.7.1. deploy-aws-monitoring.sh
...
#### 3.7.2. deploy-openstack-monitoring.sh
...
#### 3.7.3. deploy-azure-monitoring.sh
...
#### 3.7.4. deploy-gcp-monitoring.sh
...
#### 3.7.5. deploy-vsphere-monitoring.sh
...
#### 3.7.6. deploy-bosh-lite-monitoring.sh
...
| paasta-addon/paasta-monitoring.yml | PaaS-TA Monitoring Agent 적용 | Requires value :  -v metric\_url |
...
Monitoring Agent는 BOSH VM의 상태 정보\(Metric data\)를 paasta-monitoring의 influxdb에 전송한다. Syslog Agent는 BOSH VM의 log 정보를 logsearch의 ls-router에 전송하는 역할을 한다. BOSH 설치 전에 paasta-monitoring의 influxdb ip를 metric\_url로 사용하기 위해 사전에 정의해야 한다. 마찬가지로 logsearch의 ls-router ip도 syslog\_address로 연동하기 위해 사전에 정의해야 한다.
...
2. uaa\_login\_links\_passwd : uaa 페이지에서 Reset password 버튼 클릭 시 이동하는 링크 주소 ![](../../../.gitbook/assets/uaa-login.png)
...
5. uaa\_clients\_portalclinet\_secret : uaac portalclient에 접근하기 위한 secret 변수
   ...
   ![](../../../.gitbook/assets/paasta-value%20%281%29.png)
...
> $ bosh -e {director\_name} vms -d paasta
...
CF CLI를 설치하고 PaaS-TA에 로그인한다. CF api는 PaaS-TA 배포 시 지정했던 System Domain 명을 사용한다.
...
> $ cf api api.{system\_domain} --skip-ssl-validation
