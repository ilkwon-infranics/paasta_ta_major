...
![](../../../.gitbook/assets/paas-ta-portal_01%20%282%29.png)
...
1. uaac client add portalclient –s “portalclient Secret”
   ...
   >
   > ![](../../../.gitbook/assets/paas-ta-portal_28%20%282%29.jpg)
...
* 가이드의 DB tool을 이용한 마이그레이션 설명은 navicat을 기준으로 한다.
  ...
  **2. 마이그레이션할 table의 레코드 데이터를 전부 삭제한다.**
  ...
  > ![](../../../.gitbook/assets/paas-ta-portal_25%20%281%29.png)
  >
  > #### 3. Tools - Data Transfer를 클릭해서 마이그레이션 설정창을 띄운다.
  >
  > ![](../../../.gitbook/assets/paas-ta-portal_21%20%281%29.png)
  >
  > #### 4. 마이그레이션할 source DB\(기존 DB\), target DB\(Paas-TA 3.5 Portal DB\)를 설정한다.
  >
  > ![](../../../.gitbook/assets/paas-ta-portal_20%20%281%29.png)
  >
...
1. 관리자 포탈에 접속한다.\(portal-web-admin.\[public ip\].xip.io\)
   ...
   > ![](../../../.gitbook/assets/paas-ta-portal_15%20%282%29.png)

2. 운영관리를 누른다.

   > ![](../../../.gitbook/assets/paas-ta-portal_16%20%282%29.png)

3. 카탈로그 페이지에 들어간다.

   > ![](../../../.gitbook/assets/paas-ta-portal_17%20%282%29.png)

4. 빌드팩, 서비스팩 상세화면에 들어가서 각 항목란에 값을 입력후에 저장을 누른다.

   > ![](../../../.gitbook/assets/paas-ta-portal_18%20%282%29.png)

5. 사용자포탈에서 변경된값이 적용되어있는지 확인한다.

   > ![](../../../.gitbook/assets/paas-ta-portal_19.png)
...
2. 사용자 포탈의 앱 상세 페이지로 이동한다.
   ...
   > ![](../../../.gitbook/assets/paas-ta-portal_30%20%281%29.png)
