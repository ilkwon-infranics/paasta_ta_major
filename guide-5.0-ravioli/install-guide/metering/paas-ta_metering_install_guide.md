# PAAS-TA\_METERING\_INSTALL\_GUIDE

## Table of Contents

[1. 문서 개요](paas-ta_metering_install_guide.md)

* [1.1 목적](paas-ta_metering_install_guide.md#1)

[2. Abacus 배포](paas-ta_metering_install_guide.md)

* [2.1 배포 전제 조건](paas-ta_metering_install_guide.md#2)
* [2.2 필수 프로그램 설치](paas-ta_metering_install_guide.md#3)  
* [2.3 MogoDB,RabbitMQ](paas-ta_metering_install_guide.md#4)  
* [2.4 UAA 계정 등록](paas-ta_metering_install_guide.md#7)  
* [2.5 Abacus 베포를 위한 조직 및 영역 설정](paas-ta_metering_install_guide.md#8)  
* [2.6 cf-abacus 배포](paas-ta_metering_install_guide.md#9)  

[3. API 호출](paas-ta_metering_install_guide.md)

* [3.1 Token 생성](paas-ta_metering_install_guide.md#10)  
* [3.2 paasta-usage-repoting 데이터 추출](paas-ta_metering_install_guide.md#11)  
...
![](https://github.com/ilkwon-infranics/paasta_ta_major/tree/eb3c24b839eb2159e49dd8ecf6f2cf529b04aac9/install-guide/metering/images/IMAGE1.png)
...
![](https://github.com/ilkwon-infranics/paasta_ta_major/tree/eb3c24b839eb2159e49dd8ecf6f2cf529b04aac9/install-guide/metering/images/IMAGE2.png)
...
![](https://github.com/ilkwon-infranics/paasta_ta_major/tree/eb3c24b839eb2159e49dd8ecf6f2cf529b04aac9/install-guide/metering/images/IMAGE3.png)
...
추가적인 정보를 취득하기 위해서는,  
참조 : [https://github.com/cloudfoundry-incubator/cf-abacus](https://github.com/cloudfoundry-incubator/cf-abacus)  
API : [https://github.com/cloudfoundry-incubator/cf-abacus/blob/master/doc/api.md](https://github.com/cloudfoundry-incubator/cf-abacus/blob/master/doc/api.md)
