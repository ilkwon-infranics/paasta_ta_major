...
![](../../../.gitbook/assets/mysql_vsphere_1.3.01%20%282%29.png)
...
![](../../../.gitbook/assets/update_mysql_vsphere_41.png) ![](../../../.gitbook/assets/update_mysql_vsphere_42.png) ![](../../../.gitbook/assets/update_mysql_vsphere_43.png) ![](../../../.gitbook/assets/update_mysql_vsphere_44.png) ![](../../../.gitbook/assets/update_mysql_vsphere_45.png)
...
![](../../../.gitbook/assets/update_mysql_vsphere_46.png)

* Deploy시 사용할 Stemcell을 확인한다.

> `$ bosh stemcells`

![](../../../.gitbook/assets/update_mysql_vsphere_47.png)
...
> $ bosh deploy  
>  ※ 40분 ~ 1시간 정도 소요된다. ![](../../../.gitbook/assets/update_mysql_vsphere_49.png) ![](../../../.gitbook/assets/update_mysql_vsphere_50.png)
...
> `$ cf service-brokers`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_16%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_17%20%282%29.png)
...
> `$ cf service-access`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_19%20%281%29.png)
>
...
> `$ cf service-access`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_20%20%282%29.png)
...
> `$ ls -all`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_21%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_23%20%282%29.png)
...
> `$ cf push --no-start`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_25%20%282%29.png)

#### 배포된 Sample App을 확인하고 로그를 수행한다.

> `$ cf apps`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_26%20%282%29.png)
>
> `$ cf logs {배포된 App명}`
>
> `$ cf logs hello-spring-mysql`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_27%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_29%20%282%29.png)
>
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_30%20%281%29.png)

#### 모든 App에 Mysql 서비스를 사용할수 있도록 생성한 보안 그룹을 적용한다.

> `$ cf bind-running-security-group p-mysql`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_31%20%282%29.png)

#### App을 리부팅 한다.

> `$ cf restart hello-spring-mysql`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_32%20%282%29.png)
...
>
> 브라우져에서 확인 ![](../../../.gitbook/assets/update_mysql_vsphere_34%20%282%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.02%20%282%29.png)

#### HeidSQL 설치를 위한 안내사항이다. Next 버튼을 클릭한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.03%20%281%29.png)

#### 프로그램 라이선스에 관련된 내용이다. 동의\(I accept the agreement\)에 체크 후 Next 버튼을 클릭한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.04%20%282%29.png)
...
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.06%20%282%29.png)
...
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.07%20%282%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.09%20%282%29.png)

#### HeidiSQL을 실행했을 때 처음 뜨는 화면이다. 이 화면에서 Server에 접속하기 위한 profile을 설정/저장하여 접속할 수 있다. 신규 버튼을 클릭한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.10%20%282%29.png)

#### 어떤 Server에 접속하기 위한 Connection 정보인지 별칭을 입력한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.11%20%282%29.png)

#### 네트워크 유형의 목록에서 MySQL\(SSH tunel\)을 선택한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.12%20%282%29.png)

#### 아래 붉은색 영역에 접속하려는 서버 정보를 모두 입력한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.13.png)
>
...
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.15%20%282%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.16%20%281%29.png)

#### 우측 화면에 쿼리 탭을 클릭하여 Query문을 작성한 후 실행 버튼\(삼각형\)을 클릭한다.

> 쿼리문에 이상이 없다면 정상적으로 결과를 얻을 수 있을 것이다.
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.17%20%281%29.png)
