...
![](../../../.gitbook/assets/redis_openstack_02.png)
...
> `$ls –all`
>
> ![](../../../.gitbook/assets/redis_openstack_03.png)

#### 업로드 되어 있는 릴리즈 목록을 확인한다.

> `$ bosh releases`
>
> ![](../../../.gitbook/assets/redis_openstack_04.png)
>
...
>
> ![](../../../.gitbook/assets/redis_openstack_05.png)
>
> ![](../../../.gitbook/assets/redis_openstack_06.png)
>
> ![](../../../.gitbook/assets/redis_openstack_07.png)
>
> ![](../../../.gitbook/assets/redis_openstack_08.png)

#### 업로드 된 Redis릴리즈를 확인한다.

> `$ bosh releases`
>
> ![](../../../.gitbook/assets/redis_openstack_09.png)
>
...
> `$ ls –all`
>
> ![](../../../.gitbook/assets/redis_openstack_10.png)
...
> `$ bosh status`
>
> ![](../../../.gitbook/assets/redis_openstack_11.png)

#### Deploy시 사용할 Stemcell을 확인한다. \(Stemcell 3147 버전 사용\)

> `$ bosh stemcells`
>
> ![](../../../.gitbook/assets/redis_openstack_12.png)
>
...
>
> ![](../../../.gitbook/assets/redis_openstack_13.png)

#### Redis서비스팩을 배포한다.

> `$ bosh deploy`
>
> ![](../../../.gitbook/assets/redis_openstack_14.png)
>
> ![](../../../.gitbook/assets/redis_openstack_15.png)

#### 배포된 Redis서비스팩을 확인한다.

> `$ bosh vms`
>
> ![](../../../.gitbook/assets/redis_openstack_16.png)
>
> ![](../../../.gitbook/assets/redis_openstack_17.png)
...
> `$ cf service-brokers`
>
> ![](../../../.gitbook/assets/redis_openstack_18.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_19.png)

#### 등록된 Redis 서비스 브로커를 확인한다.

> `$ cf service-brokers`
>
> ![](../../../.gitbook/assets/redis_openstack_20.png)

#### 접근 가능한 서비스 목록을 확인한다.

> `$ cf service-access`
>
> ![](../../../.gitbook/assets/redis_openstack_21.png)
>
...
> `$ cf service-access`
>
> ![](../../../.gitbook/assets/redis_openstack_22.png)
...
> `$ ls -all`
>
> ![](../../../.gitbook/assets/redis_openstack_23.png)
...
> `$ cf marketplace`
>
> ![](../../../.gitbook/assets/redis_openstack_24.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_25.png)

#### 생성된 Redis 서비스 인스턴스를 확인한다.

> `$cf services`
>
> ![](../../../.gitbook/assets/redis_openstack_26.png)
...
> `$ cf push --no-start`
>
> ![](../../../.gitbook/assets/redis_openstack_27.png)

#### 배포된 Sample App을 확인하고 로그를 수행한다.

> `$ cf apps`
>
> ![](../../../.gitbook/assets/redis_openstack_28.png)
>
> `$ cf logs {배포된 App명}`
>
> `$ cf logs redis-example-app`
>
> ![](../../../.gitbook/assets/redis_openstack_29.png)

#### Sample App에서 생성한 서비스인스턴스바인드 신청을 한다.

> `$ cf bind-service redis-example-appredis-service-instance`
>
> ![](../../../.gitbook/assets/redis_openstack_30.png)

#### 바인드가 적용되기 위해서 App을 재기동한다.

> `$ cf restart redis-example-app`
>
> ![](../../../.gitbook/assets/redis_openstack_31.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_32.png)
...
> `$ curl -X GET $APP/foo`
>
> ![](../../../.gitbook/assets/redis_openstack_33.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_34.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_35.png)

#### 다운로드한 설치파일을 실행한다.

> ![](../../../.gitbook/assets/redis_openstack_36.png)

#### Redis Desktop Manager 설치를 위한 안내사항이다. Next 버튼을 클릭한다.

> ![](../../../.gitbook/assets/redis_openstack_37.png)

#### 프로그램 라이선스에 관련된 내용이다. I Agree 버튼을 클릭한다.

> ![](../../../.gitbook/assets/redis_openstack_38.png)

#### Redis Desktop Manager를 설치할 경로를 설정 후 Install 버튼을 클릭한다.

> 별도의 경로 설정이 필요 없을 경우 default로 C드라이브 Program Files 폴더에 설치가 된다.
>
> ![](../../../.gitbook/assets/redis_openstack_39.png)

#### 설치 완료 후 Next 버튼을 클릭하여 다음 과정을 진행한다.

> ![](../../../.gitbook/assets/redis_openstack_40.png)

#### Finish 버튼 클릭으로 설치를 완료한다.

> ![](../../../.gitbook/assets/redis_openstack_41.png)
...
>
> ![](../../../.gitbook/assets/redis_openstack_45.png)

#### 접속이 완료되고 좌측 서버 정보를 더블 클릭하면 좌측에 스키마 정보가 나타난다.

> ![](../../../.gitbook/assets/redis_openstack_46.png)

#### 신규 키 등록후 확인

> ![](../../../.gitbook/assets/redis_openstack_47.png)
