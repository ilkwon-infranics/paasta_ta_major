...
> `$ ls –all`
>
> ![](../../../.gitbook/assets/image3%20%286%29.png)
...
>
> ![](../../../.gitbook/assets/image4%20%286%29.png)
>
> ![](../../../.gitbook/assets/image5%20%284%29.png)

* 업로드 된API 플랫폼 릴리즈를 확인한다.

> `$ bosh releases`
>
> ![](../../../.gitbook/assets/image6%20%285%29.png)
>
...
> `$ bosh stemcells`
>
> ![](../../../.gitbook/assets/image9%20%286%29.png)
>
...
> `$ bosh vms`
>
> ![](../../../.gitbook/assets/image13%20%284%29.png)
...
> ![](../../../.gitbook/assets/image14%20%285%29.png)
...
> ![](../../../.gitbook/assets/image17%20%285%29.png)
...
> ![](../../../.gitbook/assets/image20%20%281%29.png)
...
> ![](../../../.gitbook/assets/image21%20%286%29.png)
...
> ![](../../../.gitbook/assets/image22%20%282%29.png)
...
※ ④번 Edit Swagger Definition 버튼을 클릭하여 다음의 [\[4. Resources 정의\]](servicebroker_apiplatform_aws_install_guide.md#DefineResources) 과정을 생략 할 수 있다. 이에 대한 설명은 [\[4. Resources 정의\]](servicebroker_apiplatform_aws_install_guide.md#DefineResources) 하단에 [\[Swagger 정의\]](servicebroker_apiplatform_aws_install_guide.md#DefineSwagger)로 첨부한다.

> ![](../../../.gitbook/assets/image25%20%285%29.png)
...
※ Swagger 정의  
 상단의 [\[3. General Details 정의\]](servicebroker_apiplatform_aws_install_guide.md#DefineGeneralDetails)에서 푸른색 ④번 박스로 표시된 Edit Swagger Definition 버튼을 클릭하면 Swagger 수정이 가능하다. 다음과 같이 수정하고 Save버튼을 클릭하여 Resources를 정의한다. 이 방법을 통해 상단에 기술된 [\[4. Resources 정의\]](servicebroker_apiplatform_aws_install_guide.md#DefineResources) 절차를 생략할 수 있다.
...
> ![](../../../.gitbook/assets/image29%20%285%29.png)
...
> ![](../../../.gitbook/assets/image30%20%284%29.png)
...
> ![](../../../.gitbook/assets/image31%20%284%29.png)
...
>
> ![](../../../.gitbook/assets/image33%20%282%29.png)

* 등록된 API 플랫폼 서비스 브로커를 확인한다.

> `$ cf service-brokers`
>
> ![](../../../.gitbook/assets/image34%20%282%29.png)
...
> `$ cf service-access`
>
> ![](../../../.gitbook/assets/image36%20%282%29.png)
...
[\[2.4 API 매니저에서 API 생성 및 배포\]](servicebroker_apiplatform_aws_install_guide.md#APICreatePublish)에서 생성한 API 서비스를 샘플 App에 바인드하여, Vcap 환경설정 정보를 정상적으로 획득할 수 있는지를 확인함으로써 연동여부를 확인한다. 단순히 서비스 바인드만 진행하기 때문에 샘플 어플리케이션은 어떤 어플리케이션을 사용해도 무방하다.
...
> `$ cf push --no-start`
>
> ![](../../../.gitbook/assets/image38%20%283%29.png)

* 배포된 Sample App을 확인하고 로그를 수행한다.

> `$ cf apps`
>
> ![](../../../.gitbook/assets/image39%20%282%29.png)
>
> `$ cf logs hello-servlet-tomcat`
>
> ![](../../../.gitbook/assets/image40%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/image44%20%282%29.png)
