...
![](../../../.gitbook/assets/mysql_vsphere_1.3.01%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_17%20%281%29.png)

#### 등록된 MySQL 서비스 브로커를 확인한다.

> `$ cf service-brokers`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_18%20%281%29.png)

#### 접근 가능한 서비스 목록을 확인한다.

> `$ cf service-access`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_19%20%282%29.png)
>
...
> `$ cf service-access`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_20%20%281%29.png)
...
> `$ ls -all`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_21%20%282%29.png)
...
> `$ cf marketplace`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_22%20%282%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_23%20%281%29.png)

#### 생성된 MySQL 서비스 인스턴스를 확인한다.

> `$ cf services`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_24%20%281%29.png)
...
> `$ cf apps`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_26%20%281%29.png)
>
> `$ cf logs {배포된 App명}`
>
> `$ cf logs hello-spring-mysql`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_27%20%282%29.png)

#### Sample Web App에서 생성한 서비스 인스턴스 바인드 신청을 한다.

> `$ cf bind-service hello-spring-mysql mysql-service-instance`
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_28%20%282%29.png)
...
>
> ![](../../../.gitbook/assets/update_mysql_vsphere_33%20%281%29.png)
>
> 브라우져에서 확인 ![](../../../.gitbook/assets/update_mysql_vsphere_34%20%281%29.png)
...
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.01%20%282%29.png)

#### 다운로드한 설치파일을 실행한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.02%20%281%29.png)

#### HeidSQL 설치를 위한 안내사항이다. Next 버튼을 클릭한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.03.png)

#### 프로그램 라이선스에 관련된 내용이다. 동의\(I accept the agreement\)에 체크 후 Next 버튼을 클릭한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.04%20%281%29.png)

#### HeidiSQL을 설치할 경로를 설정 후 Next 버튼을 클릭한다.

> 별도의 경로 설정이 필요 없을 경우 default로 C드라이브 Program Files 폴더에 설치가 된다.
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.05%20%282%29.png)

#### 설치 완료 후 시작메뉴에 HeidiSQL 바로가기 아이콘의 이름을 설정하는 과정이다.

> Next 버튼을 클릭하여 다음 과정을 진행한다.
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.06%20%281%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.08%20%282%29.png)

#### Finish 버튼 클릭으로 설치를 완료한다.

> ![](../../../.gitbook/assets/mysql_vsphere_4.1.09%20%281%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.11%20%281%29.png)
...
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.13%20%282%29.png)
>
> 서버 정보는 Application에 바인드되어 있는 서버 정보를 입력한다. cf env  명령어로 이용하여 확인한다.
>
> **예\)** $cf env hello-spring-mysql
>
> ![](../../../.gitbook/assets/mysql_vsphere_4.1.14%20%281%29.png)
