# PaaS-TA Container 서비스팩 설치 가이드\_v1.0
...
![](../../../.gitbook/assets/container_service_architecture%20%281%29.png)
...
* Deploy 스크립트 파일을 서버 환경에 맞게 수정한다.
  * vSphere : **deploy\_vsphere.sh**
  * AWS : **deploy\_aws.sh**
  * OpenStack : **deploy\_openstack.sh**
